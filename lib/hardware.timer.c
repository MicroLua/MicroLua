...
static int mod_enable_alarm(lua_State* ls) {
    ...
    Event* ev = &alarm_state[get_core_num()].events[alarm];
...
static bool get_pending(struct AlarmState* state, uint alarm) {
